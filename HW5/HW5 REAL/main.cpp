...
void student_tests() {
  ...
  Essay essay = Essay();//create a template essay
  essay.push_back("qwe");
  essay.push_back("rty");
  essay.push_back("uio");
  essay.push_back("asd");
  essay.backup();// should be qwe rty uio asd|NULL
  essay.push_front("111");//should be 111 qwe rty uio asd|qwe rty uio asd
  Essay::iterator i = essay.begin();
  i++;
  i++;
  i = essay.erase(i);
  i = essay.erase(i);//should be 111 qwe asd|qwe rty uio asd
  Essay copyEssay = Essay(essay);
  Essay essay2 = Essay();
  essay2 = copyEssay;
  assert(print(copyEssay,true) == print(essay,true));
  assert(print(essay2,true) == print(essay,true));
  //
